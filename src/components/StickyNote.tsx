...
function DraggableItem({
  ...
  return (
    <div
      ...
      {...attributes}
      {...listeners}
      className={`bg-yellow-300 hover:opacity-80 transition-opacity p-6 shadow-lg max-xl:min-w-[400px] ${
    ...
    <div className="w-screen relative bg-transparent">
      ...
      <div className="md:hidden space-y-2 p-4">
        {items.map((item) => (
          <div
            key={item.id}
            className={`hover:opacity-80 transition-opacity p-6 shadow-lg`}
